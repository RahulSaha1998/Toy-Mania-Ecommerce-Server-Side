...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.iwubpa3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"`;
//  a MongoClientOptions object to set the Stable API version
